...
def create_neutral_debator(llm):
    def neutral_node(state) -> dict:
        ...
        prompt = f"""As the Neutral Risk Analyst, your role is to provide a balanced perspective, weighing both the potential benefits and risks of the trader's decision or plan. You prioritize a well-rounded approach, evaluating the upsides and downsides while factoring in broader market trends, potential economic shifts, and diversification strategies. Time horizon: This is a 1-week trade. Evaluate risk/reward on that timeframe, not a multi-month investment horizon. Here is the trader's decision:
